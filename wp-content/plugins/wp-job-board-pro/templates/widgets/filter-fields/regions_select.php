...
$first_regions = get_terms('job_listing_location', array(
    'orderby' => 'count',
    'hide_empty' => 0,
    'parent' => 0,
    'orderby' => 'name',
    ...
    <div class="form-group form-group-<?php echo esc_attr($key); ?> tax-select-field">
        ...
        <div class="form-group-inner group-wrapper-filter <?php echo (!empty($field['icon']))?'has-icon':'' ?>">
            ...
            <div class="field-region field-region1">
                ...
                <select class="select-field-region select-field-region1 form-control" data-next="2" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder1); ?>" data-taxonomy="job_listing_location">
            ...
            ?>
                ...
                <div class="field-region field-region2">
                    <select class="select-field-region select-field-region2" data-next="3" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder2); ?>"  data-taxonomy="job_listing_location">
                        <option value=""><?php echo esc_attr($placeholder2); ?></option>
                        <?php
                        if ( !empty($parent) ) {
                            $second_regions = get_terms('job_listing_location', array(
                                'orderby' => 'count',
                                'hide_empty' => 0,
                                'parent' => $parent,
                                'orderby' => 'name',
            ...
            ?>
                ...
                <div class="field-region field-region3">
                    <select class="select-field-region select-field-region3" data-next="4" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder3); ?>"  data-taxonomy="job_listing_location">
                        <option value=""><?php echo esc_attr($placeholder3); ?></option>
                        <?php
                        if ( !empty($parent_second) ) {
                            $third_regions = get_terms('job_listing_location', array(
                                'orderby' => 'count',
                                'hide_empty' => 0,
            ...
            ?>
                <div class="field-region field-region4">
                    <select class="select-field-region select-field-region4" data-next="5" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder4); ?>" data-taxonomy="job_listing_location">
                        <option value=""><?php echo esc_attr($placeholder4); ?></option>
                        <?php
                        if ( !empty($parent_third) ) {
                            $fourth_regions = get_terms('job_listing_location', array(
                                'orderby' => 'count',
                                'hide_empty' => 0,
                                'parent' => $parent_third,
                                'orderby' => 'name',
