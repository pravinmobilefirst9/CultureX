...
class WP_Job_Board_Pro_Image {
	...
	public static function get_allowed_mime_types( $field = '' ) {
		if ( '_candidate_cv_attachment' === $field ) {
			$allowed_mime_types = WP_Job_Board_Pro_Mixes::get_cv_mime_types();
		} else {
			$allowed_mime_types = WP_Job_Board_Pro_Mixes::get_image_mime_types();
		}

		return apply_filters( 'wp_job_board_pro_mime_types', $allowed_mime_types, $field );
	}
