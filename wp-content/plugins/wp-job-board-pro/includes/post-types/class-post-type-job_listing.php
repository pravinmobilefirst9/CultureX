...
class WP_Job_Board_Pro_Post_Type_Job_Listing {
	...
	public static function process_mark_filled_job() {
		...
		$return = array( 'status' => true, 'msg' => esc_html__('ob has been successfully marked as \'filled\'', 'wp-job-board-pro'), 'title' => esc_html__('Mark not filled', 'wp-job-board-pro'), 'nonce' => wp_create_nonce( 'wp-job-board-pro-mark-not-filled-nonce' ), 'icon_class' => 'fa fa-lock',
