...
class WP_Job_Board_Pro_Employer {
	...
	public static function init() {
		...
		// restrict
		add_action( 'wp-job-board-pro-employer-query-args', array( __CLASS__, 'employer_restrict_listing_query_args'), 100, 2 );
		add_action( 'wp-job-board-pro-employer-filter-query', array( __CLASS__, 'employer_restrict_listing_query'), 100, 2 );
	...
	public static function add_employee() {
		...
		// add employee user
		WP_Job_Board_Pro_User::registration_validation( $_POST['username'], $_POST['email'], $_POST['password'], $_POST['confirmpassword'], false, false );
