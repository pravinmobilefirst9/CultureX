...
if ( '0' !== $item_template_id ) {
    ...
    if ( ! empty( $template_content ) ) {
        ...
        $content_html = '<div class="no-template-message"><span>' . esc_html__( 'The tabs are working. Please, note, that you have to add a template to the library in order to be able to display it inside the tabs.', 'superio' ) . '</span></div>';
    }
} else {
