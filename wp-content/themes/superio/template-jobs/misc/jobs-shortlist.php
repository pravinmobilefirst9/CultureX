							...
							<tr class="job-applied-wrapper">
								...
								<td>
									<div class="action-button">
										<a href="javascript:void(0)" class="btn-remove-job-shortlist btn-action-icon deleted" data-job_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-pro-remove-job-shortlist-nonce' )); ?>"><i class="ti-close"></i></a>
