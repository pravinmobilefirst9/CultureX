					        ...
					        <div class="flex-middle-sm">
					            ...
					            <div class="ali-right">
					                <div class="action-button">
					                    ...
					                    <a data-toggle="tooltip" class="btn-action-icon btn-candidate-private-message" href="#" data-candidate_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-private-message-send-message-form-nonce' )); ?>" title="<?php esc_attr_e('Send message', 'superio'); ?>"><i class="ti-email"></i></a>
