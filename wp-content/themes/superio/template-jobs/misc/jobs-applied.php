...
<div class="box-dashboard-wrapper">
	...
	<div class="inner-list">
						...
						<tr class="job-applied-wrapper">
							...
							<td>
								<div class="action-button">
									<a href="javascript:void(0)" class="btn-remove-job-applied btn-action-icon deleted" data-applicant_id="<?php echo esc_attr($applicant_id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-pro-remove-applied-nonce' )); ?>"><i class="ti-close"></i></a>
									<a class="btn-action-icon" href="<?php echo esc_url(get_permalink($job_id)); ?>"><i class="ti-eye"></i></a>
								</div>
							</td>
						</tr>
		...
		<?php } else { ?>
			<div class="not-found"><?php esc_html_e('No apply found.', 'superio'); ?></div>
		<?php } ?>
	</div>
</div>