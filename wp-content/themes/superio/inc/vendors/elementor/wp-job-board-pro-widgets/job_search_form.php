        ...
        if ( !empty($search_fields) ) {
            foreach ($search_fields as $item) {
                ...
                if ( $item['filter_layout'] ) {
                    if ( in_array($item['filter_field'], array('type', 'category', 'location')) ) {
                    ...
                    } elseif ( in_array($item['filter_field'], array('experience', 'gender', 'industry', 'qualification', 'career_level')) ) {
                        switch ($item['filter_layout']) {
                            case 'radio':
