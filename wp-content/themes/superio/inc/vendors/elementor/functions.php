...
if( ! class_exists( 'Superio_Elementor_Extensions' ) ) {
    final class Superio_Elementor_Extensions {
        ...
        public function __construct() {
            ...
            add_filter( 'superio_generate_post_builder', array( $this, 'render_post_builder' ), 10, 2 );
        ...
        public function add_widget_categories( $elements_manager ) {
            $elements_manager->add_category(
                'superio-elements',
                [
                    'title' => esc_html__( 'Superio Elements', 'superio' ),
                    'icon' => 'fa fa-shopping-bag',
                ]
            );

            $elements_manager->add_category(
                'superio-header-elements',
                [
                    'title' => esc_html__( 'Superio Header Elements', 'superio' ),
                    'icon' => 'fa fa-shopping-bag',
                ]
            );
        ...
        public function elementor_widgets() {
            ...
            if ( superio_is_mailchimp_activated() ) {
            ...
            if ( superio_is_wp_job_board_pro_activated() ) {
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/jobs' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/jobs_tabs' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/employers' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/job_category_banner' );
                
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/candidate_category_banner' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/job_city_banner' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/candidate_city_banner' );

                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/job_search_form' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/candidate_search_form' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/employer_search_form' );
                
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/candidates' );

                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/user_info' );
                
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/add-job-btn' );
                get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/upload-cv-btn' );

                if ( defined('WP_JOB_BOARD_PRO_PLUGIN_VERSION') && version_compare(WP_JOB_BOARD_PRO_PLUGIN_VERSION, '1.2.0', '>=') ) {
                    get_template_part( 'inc/vendors/elementor/wp-job-board-pro-widgets/header-notification' );
                }
            }

            if ( superio_is_wp_job_board_pro_wc_paid_listings_activated() && superio_is_woocommerce_activated() ) {
        ...
        public function style() {
            wp_enqueue_style('superio-flaticon',  get_template_directory_uri() . '/css/flaticon.css');
        ...
        public function modify_controls( $controls_registry ) {
            ...
            $new_icons = array_merge(
                array(
                    ...
                    'flaticon-briefcase-1' => 'flaticon-briefcase-1',
                    'flaticon-wall-clock' => 'flaticon-wall-clock',
                    'flaticon-money-1' => 'flaticon-money-1',
                    'flaticon-job-search' => 'flaticon-job-search',
                    'flaticon-testing' => 'flaticon-testing',
                    'flaticon-contact-book' => 'flaticon-contact-book',
                    'flaticon-user' => 'flaticon-user',
                    'flaticon-calendar' => 'flaticon-calendar',
                    'flaticon-waiting' => 'flaticon-waiting',
                    ...
                    'flaticon-businessman' => 'flaticon-businessman',
                    'flaticon-package' => 'flaticon-package',
                    'flaticon-refresh' => 'flaticon-refresh',
                    'flaticon-password' => 'flaticon-password',
                    ...
                    'flaticon-magnifiying-glass' => 'flaticon-magnifiying-glass',
                ),
                $icons
            );
...
if ( did_action( 'elementor/loaded' ) ) {
    ...
    Superio_Elementor_Extensions::instance();
}